...
DATA_FOLDER = os.path.join(DATA_FOLDER, typeName)
DEFAULT_FIN = os.path.join(DATA_FOLDER, typeName+'_content.txt')
DEFAULT_FTOPICS = os.path.join(DATA_FOLDER, typeName+'_topics.txt')
DEFAULT_FWORDS = os.path.join(DATA_FOLDER,typeName+ 'words')
DEFAULT_FTOPIC_WORDS = os.path.join(DATA_FOLDER, typeName+'topic_words')
DEFAULT_N_TOPIC = 10
